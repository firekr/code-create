                        ...
                        <div>
                            <div class="widget radius-bordered">
                                <div class="widget-body">
                                    <form id="updateForm" action="${"$"}{contextPath}/${moduleName}/save${entityCamelName}" method="post" class="form-horizontal" onsubmit="return checkForm()">
